...
public class ScreensController extends StackPane {
    ...
    public boolean loadScreen(String name, String resource) {
        try {
            ...
            System.out.println("[Debug] Location is not set.1");
            System.out.println(e.getMessage());
            System.out.println("[Debug] Location is not set.2");
            return false;
        }
    }
...
}// end class - public class ScreensController extends StackPane
